    ...
    <header className="fixed top-0 left-0 w-full z-50 glass-nav h-20 flex items-center">
      <div className="container mx-auto px-6 md:px-12 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center gap-8 bg-white/5 px-6 py-2.5 rounded-full border border-white/10">
          <a className="text-sm font-medium hover:text-brand transition-colors" href="#about">
            About Me
          </a>
          <a className="text-sm font-medium hover:text-brand transition-colors" href="#experience">
            Experience
          </a>
          <a className="text-sm font-medium hover:text-brand transition-colors" href="#projects">
            Projects
          </a>
          <a className="text-sm font-medium hover:text-brand transition-colors" href="#contact">
            Contact Me
          </a>
          {/* Theme Toggle Dummy */}
          <div
          ...
          >
            <div
              className={`w-4 h-4 bg-brand rounded-full transition-transform duration-300 ${
                themeActive ? "translate-x-5" : "translate-x-0"
              }`}
            ></div>
          </div>
        </nav>
        <div className="flex items-center gap-4">
          <a
            className="px-6 py-2.5 border border-white/20 rounded-full text-sm font-semibold hover:bg-white hover:text-black transition-all duration-300"
            href="#"
          >
            Download CV
          </a>
